...
mysql_user=config_file["connection"]['mysql']['host']
mysql_password=config_file["connection"]['mysql']['host']
mysql_database=config_file["connection"]['mysql']['host']
mysql_port=config_file["connection"]['mysql']['host']

mongodb_host=config_file["connection"]['mysql']['host']
mongodb_user=config_file["connection"]['mysql']['host']
mongodb_password=config_file["connection"]['mysql']['host']
mongodb_database=config_file["connection"]['mysql']['host']
mongodb_port=config_file["connection"]['mysql']['host']
